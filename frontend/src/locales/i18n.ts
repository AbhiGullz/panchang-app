...
const resources = {
  ...
  mr: {
    translation: {
      appName: 'पंचांग', onboardingTitle: 'दैनंदिन डीफॉल्ट निवडा', onboardingBody: 'तुमचे शहर, पंचांग परंपरा आणि भाषा निवडा. नंतर सेटिंग्जमध्ये बदल करू शकता.', useCurrentLocation: 'सध्याचे स्थान वापरा', continue: 'पुढे जा', today: 'आज', home: 'मुख्यपृष्ठ', muhurta: 'मुहूर्त', festivals: 'सण', settings: 'सेटिंग्ज',
