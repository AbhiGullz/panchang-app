...
const resources = {
  en: {
    translation: {
      ...
      feedbackBody: 'Report a problem or share an improvement suggestion with the Gajaa Panchang team.',
      feedbackMessage: 'Your feedback',
      feedbackPlaceholder: 'Describe the issue or suggestion…',
      sendFeedback: 'Open email',
      back: 'Back',
