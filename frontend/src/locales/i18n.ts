...
const resources = {
  ...
  pa: {
    translation: {
      appName: 'ਪੰਚਾਂਗ', onboardingTitle: 'ਰੋਜ਼ਾਨਾ ਡਿਫ਼ਾਲਟ ਸੈੱਟ ਕਰੋ', onboardingBody: 'ਆਪਣਾ ਸ਼ਹਿਰ, ਪੰਚਾਂਗ ਪਰੰਪਰਾ ਅਤੇ ਭਾਸ਼ਾ ਚੁਣੋ। ਤੁਸੀਂ ਬਾਅਦ ਵਿੱਚ ਸੈਟਿੰਗਾਂ ਵਿੱਚ ਬਦਲ ਸਕਦੇ ਹੋ।', useCurrentLocation: 'ਮੌਜੂਦਾ ਟਿਕਾਣਾ ਵਰਤੋ', continue: 'ਜਾਰੀ ਰੱਖੋ', today: 'ਅੱਜ', muhurta: 'ਮੁਹੂਰਤ', festivals: 'ਤਿਉਹਾਰ', settings: 'ਸੈਟਿੰਗਾਂ', dateLabel: 'ਤਾਰੀਖ', language: 'ਭਾਸ਼ਾ', calendarSchool: 'ਪੰਚਾਂਗ ਪਰੰਪਰਾ', notificationTime: 'ਸੂਚਨਾ ਦਾ ਸਮਾਂ', ayanamsa: 'ਅਯਨਾਂਸ਼', howCalculated: 'ਇਹ ਕਿਵੇਂ ਗਿਣਿਆ ਗਿਆ', traditionMeta: 'ਪਰੰਪਰਾ', timezone: 'ਸਮਾਂ ਖੇਤਰ', location: 'ਟਿਕਾਣਾ', version: 'ਵਰਜਨ', offlineReady: 'ਪਿਛਲੇ 7 ਦਿਨਾਂ ਲਈ ਆਫ਼ਲਾਈਨ ਕੈਸ਼ ਤਿਆਰ ਹੈ।', calculatedReference: 'ਗਿਣੇ ਹੋਏ ਸਮੇਂ ਲਈ ਸਿਰਫ਼ ਹਵਾਲਾ।', festivalsForYear: 'ਤਿਉਹਾਰ ਕੈਲੰਡਰ', save: 'ਸੰਭਾਲੋ', geolocationDenied: 'ਟਿਕਾਣੇ ਦੀ ਇਜਾਜ਼ਤ ਰੱਦ ਹੋ ਗਈ। ਦਿੱਲੀ ਡਿਫ਼ਾਲਟ ਵਰਤੀ ਜਾ ਰਹੀ ਹੈ।', city: 'ਸ਼ਹਿਰ', changeLocation: 'ਟਿਕਾਣਾ ਬਦਲੋ', changeLocationTitle: 'ਨਵਾਂ ਟਿਕਾਣਾ ਖੋਜੋ', cancel: 'ਰੱਦ ਕਰੋ', schoolSelectorHint: 'ਨਾਮ ਬੈਕਐਂਡ ਤੋਂ ਆਉਂਦੇ ਹਨ; UI ਦੇ ਸ਼ਬਦ ਤੁਰੰਤ ਬਦਲਦੇ ਹਨ।', pushNotifications: 'ਪੁਸ਼ ਸੂਚਨਾਵਾਂ', subscribe: 'ਸਬਸਕ੍ਰਾਈਬ ਕਰੋ', subscribed: 'ਸਬਸਕ੍ਰਾਈਬ ਕੀਤਾ', tithi: 'ਤਿਥੀ', nakshatra: 'ਨਕਸ਼ਤਰ', sunrise: 'ਸੂਰਜ ਚੜ੍ਹਨਾ', sunset: 'ਸੂਰਜ ਡੁੱਬਣਾ', rahuKaal: 'ਰਾਹੂ ਕਾਲ', moonSign: 'ਚੰਦਰ ਰਾਸ਼ੀ', yoga: 'ਯੋਗ', karana: 'ਕਰਣ', loading: 'ਲੋਡ ਹੋ ਰਿਹਾ ਹੈ…', noData: 'ਹਾਲੇ ਆਫ਼ਲਾਈਨ ਡਾਟਾ ਉਪਲਬਧ ਨਹੀਂ ਹੈ।',
    },
  },
}
